# Ledger Lum application
[![License](https://img.shields.io/badge/License-Apache%202.0-blue.svg)](https://opensource.org/licenses/Apache-2.0)

This project contains the Lum application for Ledger Nano S and X.
Forked from the official [Ledger Cosmos app](https://github.com/cosmos/ledger-cosmos).

- Ledger Nano S/X Lum app
- Specs / Documentation
- C++ unit tests
- Zemu tests

The Lum app is not currently available in [Ledger Live](https://www.ledger.com/pages/ledger-live).

This repository will be updated as soon as the application is released on Ledger Live.

In the meantime, you can either:
- **(Recommended)** Use the official Cosmos application which also works just fine
- **(Advanced)** Use this app by building it yourself as described below
...
You can get builds generated by our CICD from the release tab.

*Warning: THESE ARE UNVETTED DEVELOPMENT RELEASES*

Download a release from the [github releases here](https://github.com/lum-network/ledger-app/releases). You only need `zxtool.sh`
...
- You eventually want to setup a python virtualenv (to avoid unecessary troubles)
